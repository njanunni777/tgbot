            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="🎉 Add me to your group", url="t.me/{}?startgroup=true".format(bot.username)),  InlineKeyboardButton(text="🤖 Make Own Admin Bot", url="https://youtu.be/W6CLKrehy6w")],
                     [InlineKeyboardButton(text="👥 Join Group", url="https://t.me/pdxmoviesmp4"), InlineKeyboardButton(text="🔔 Update Channel", url="https://t.me/KochuUpdates")],
                     [InlineKeyboardButton(text="🎬 Join Channel", url="https://t.me/pdxchannel"), InlineKeyboardButton(text="🛠 Help", url="https://t.me/{}?start=help".format(bot.username)) ]]))
